"""Regression checks for the notion-tool-diff-mark casebook."""
...
from casebook.harness import assert_expected, notion_tool_diff_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(notion_tool_diff_mark_summary(), assert_expected())
